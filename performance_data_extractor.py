...
parser = argparse.ArgumentParser(description="Extract 'context', 'b1-3' and 'infos' columns from given dataframes.")
...
out_df = all_data[["context", "b1", "b2", "b3", "infos"]]

out_df.attrs = all_data.attrs

out_name = "performance-" + file.name
